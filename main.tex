...
\begin{document}
    ...
    \include{./02-elementos-textuais/relacionados}          % Trabalhos Relacionados
    \include{./02-elementos-textuais/implementacao}         % Implementação
    \include{./02-elementos-textuais/ferramentas}           % Implementação
    \include{./02-elementos-textuais/projeto}               % Uso do projeto
    \include{./02-elementos-textuais/analise}               % Analise de dados
